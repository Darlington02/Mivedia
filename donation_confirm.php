<?php
    ...
    $fundraiser_name = $_POST["name"];
    $mifund_id = $_POST["mifund_id"];
    $amount= $_POST['amount'];
    ...
    <main class="container">       
        <div class="card my-5">
            ...
            <ul class="list-group list-group-flush">
                <li class="list-group-item">Name: <?php echo $fundraiser_name; ?></li>
                <li class="list-group-item">Donator: <?php echo $email; ?></li>
                <li class="list-group-item">Amount: NGN <?php echo $amount; ?></li>
                <li class="list-group-item">
                    <a href="wallet-transfer.php?code=<?php echo $mifund_id ?>&&amount=<?php echo $amount ?>"><button class="btn btn-warning btn-block">Pay from Wallet</button></a>
                </li>
                <li class="list-group-item">
                    <form>
