    ...
    <main class="container">
        <form class="card p-4" method="post">
            ...
            <hr>
                ...
                <small class="muted-text">Ensure withdrawal name matches name on your mifund account!</small>
            </div>
            <div>
            ...
            <input type="submit" name="withdraw" class="btn btn-primary" value="Withdraw" onclick="return confirm('Are you sure?')">
        </form>
    </main>
</body>
